...
Also note that there _may_ be additional requirements we ask select customers to apply in the future, e.g. to enable Azure Sentinel at Subscription level, for a more in-depth security monitoring.
